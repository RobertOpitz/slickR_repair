...
#' @rdname slick_div
#' @export
slick_div <- function(x, css = htmltools::css(marginLeft  = 'auto',
                                              marginRight = 'auto'), 
                      type = 'img', links = NULL)
{
  UseMethod('slick_div')
...
#' @export
slick_div.list <- function(x, css = htmltools::css(marginLeft  = 'auto',
                                                   marginRight = 'auto'),
                           type = 'img', links = NULL)
{
  if (is.null(links))
...
#' @importFrom htmltools css
#' @export
slick_div.htmlwidget <- function(x, css = htmltools::css(marginLeft  = 'auto',
                                                         marginRight = 'auto'),
                                 type = 'iframe', links = NULL)
{
...
#' @export
slick_div.character <- function(x, css = htmltools::css(marginLeft  = 'auto',
                                                        marginRight = 'auto'),
                                type = 'img', links = NULL, is_file = TRUE)
{
  if (is.null(links))
    lapply(x, slick_div_chr, 
           css = css, type = type, is_file = is_file)  
  else
    mapply(slick_div_chr,
           x, links,
           MoreArgs = list(css = css, type = type, is_file = is_file),
           SIMPLIFY = FALSE, USE.NAMES = FALSE)
}

#' @export
slick_div.xml_document <- function(x, css = htmltools::css(marginLeft  = 'auto',
                                                           marginRight = 'auto'),
                                   type = 'img', links = NULL)
{
  slick_div.character(as_svg_character(x), 
                      css = css, type = type, links = links, is_file = FALSE)
}
